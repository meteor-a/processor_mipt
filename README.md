...
# Русский
[1. Команды](#Команды)  
[2. Примеры программ](#Примеры-программ)  
[3. Синтаксис команд](#Синтаксис-команд)  
...
## Ошибки синтаксиса в ассемблере
Об ошибках информируется в консоле и в файл log_syntax.txt c указанием строки и команды
